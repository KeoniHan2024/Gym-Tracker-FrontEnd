...
function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="container-fluid d-flex flex-row align-items-center vh-100 px-5">
        
        <div className="col-md-6 p-4 shadow rounded bg-light mx-1">
          {errorMessage && (
